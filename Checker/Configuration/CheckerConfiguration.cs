...
namespace Checker.Configuration
{
    public class CheckerConfiguration
    {
        ...
        public CheckerStep RunBeforePeriodicChecksStep { get; set; }
        public CheckerStep PeriodicChecksStep { get; set; }
        public CheckerStep RunAfterPeriodicChecksStep { get; set; }
